...
console.log("\n--- two sessions, end to end ---");
{
	...
	check("which the chat row says out loud", (b.sent[0].message.details as { delivery: string }).delivery, "turn");
	...
	check("a question wakes it too", b.sent[2].options, { triggerTurn: true });
